    ...
    <section className="zero-admin-section">
      <div className="container">
        ...
        >
          ...
          <h2>Eliminate CRM Data Entry — <span className="gradient-text">Let Your Team Focus on Selling</span></h2>
          <p>Your team should be selling, not doing admin. CloserMetrix auto-populates your CRM from every recorded call — zero manual data entry, zero nagging.</p>
        </motion.div>
